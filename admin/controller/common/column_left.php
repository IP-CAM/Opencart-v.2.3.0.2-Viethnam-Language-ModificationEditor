...
// 			}
			...
			if ($this->user->hasPermission('access', 'extension/module/visualbuilder')) {
			    $design[] = array(
			        'name'	   => $this->language->get('text_visual_builder'),
			        'href'     => $this->url->link('extension/module/visualbuilder', 'token=' . $this->session->data['token'], true),
			        'children' => array()
			    );
			}	
			
			if ($this->user->hasPermission('access', 'design/navigation')) {
			    $design[] = array(
			        'name'	   => $this->language->get('text_navigation'),
			        'href'     => $this->url->link('design/navigation', 'token=' . $this->session->data['token'], true),
			        'children' => array()
			    );
			}
			...
			$config = array();
    			...
    			// Language
		        if ($this->user->hasPermission('access', 'config/lang_editor')) {
    				$config[] = array(
    					'name'	   => $this->language->get('text_translation'),
    					'href'     => $this->url->link('config/lang_editor', 'token=' . $this->session->data['token'], true),
    					'children' => array()		
    				);	
			    }
    				
    			// Create Link Seo
			    if ($this->user->hasPermission('access', 'config/link_seo')) {
			        $config[] = array(
			            'name'	   => $this->language->get('text_link_seo'),
			            'href'     => $this->url->link('config/link_seo', 'token=' . $this->session->data['token'], true),
			            'children' => array()
			        );
			    }
