...
class ModelCatalogCategory extends Model {
	public function addCategory($data) {
		...
		// thanhtamit
		// thêm nhiều banner - slider cho danh mục sản phẩm
		if (isset($data['category_image'])) {
		    foreach ($data['category_image'] as $category_image) {
		        $this->db->query("INSERT INTO " . DB_PREFIX . "category_image SET category_id = '" . (int)$category_id . "', image = '" . $this->db->escape($category_image['image']) . "', link = '" . $this->db->escape($category_image['link']) . "', sort_order = '" . (int)$category_image['sort_order'] . "'");
		    }
		}
	...
	public function editCategory($category_id, $data) {
		...
		// thanhtamit
		// update nhiều hình ảnh banner - slider cho danh mục sản phẩm
	...
	public function deleteCategory($category_id) {
		...
		// thanhtamit
		// xóa hình ảnh baner - slider cho danh mục sản phẩm
		$this->db->query("DELETE FROM " . DB_PREFIX . "category_image WHERE category_id = '" . (int)$category_id . "'");
	...
	// thanhtamit
	// hàm thêm nhiều hình ảnh banner - slider cho danh mục sản phẩm
