      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <!-- thanhtamit -->
          <!-- thêm nhiều hình ảnh banner - slider cho danh mục sản phẩm -->
          <div class="tab-pane" id="tab-image">
                  ...
                  <tbody>
                    ...
                    <?php foreach ($category_images as $category_image) { ?>
                        <tr id="image-row<?php echo $image_row; ?>">
                          ...
                          <td class="text-right"><input type="text" name="category_image[<?php echo $image_row; ?>][link]" value="<?php echo $category_image['link']; ?>" placeholder="Link" class="form-control" /></td>
            ...
            <script type="text/javascript">
                ...
                function addImage() {
                  ...
                  html += '  <td class="text-left"><a href="" id="thumb-image' + image_row + '"data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /><input type="hidden" name="category_image[' + image_row + '][image]" value="" id="input-image' + image_row + '" /></td>';
                  html += '  <td class="text-right"><input type="text" name="category_image[' + image_row + '][link]" value="" placeholder="Link" class="form-control" /></td>';
