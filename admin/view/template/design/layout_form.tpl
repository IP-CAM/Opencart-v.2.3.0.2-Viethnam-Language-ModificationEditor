        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-layout" class="form-horizontal">
          ...
          <fieldset>
            ...
            <div class="header-module">
                <div class="row">
                	<!-- header top -->
                	<div class="col-lg-12 col-md-12 col-sm-12 header-top-module">
                		 <table id="module-header-top" class="table table-hover">
                      <thead>
                        <tr>
                          <td class="text-left">Header Top</td>
                        </tr>
                      </thead>
                      <tbody>
                	...
                	<!-- header bottom -->
                	<div class="col-lg-12 col-md-12 col-sm-12 header-bottom-module">
                		<table id="module-header-bottom" class="table table-hover">
                      <thead>
                        <tr>
                          <td class="text-left">Header Bottom</td>
                        </tr>
                      </thead>
                      <tbody>
                        <?php foreach ($layout_modules as $layout_module) { ?>
            ...
            <div class="main-module">
                ...
                <!-- Main Top -->
                <div class="row">
                	<div class="col-lg-12 col-md-12 col-sm-12 main-top-module">
                		 <table id="module-main-top" class="table table-hover">
                      <thead>
                        <tr>
                          <td class="text-left">Main Top</td>
                        </tr>
                      </thead>
                      <tbody>
                        <?php foreach ($layout_modules as $layout_module) { ?>
                        <?php if ($layout_module['position'] == 'main_top') { ?>
                        <tr id="module-row<?php echo $module_row; ?>">
                          <td class="text-left"><div class="input-group">
                              <select name="layout_module[<?php echo $module_row; ?>][code]" class="form-control input-sm">
                                <?php foreach ($extensions as $extension) { ?>
                      ...
                      <tfoot>
                        <tr>
                          <td class="text-left"><div class="input-group">
                              ...
                              <div class="input-group-btn">
                                <button type="button" onclick="addModule('main-top');" data-toggle="tooltip" title="<?php echo $button_module_add; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i></button>
                              </div>
                            </div></td>
                        </tr>
                      </tfoot>
                ...
                <div class="row main">
                  <!-- column left -->
                  <div class="col-lg-3 col-md-4 col-sm-12 column-left">
                    <table id="module-column-left" class="table table-hover">
                      <thead>
                        <tr>
                  ...
                  <div class="col-lg-6 col-md-4 col-sm-12 content-bottom">
                    <table id="module-content-top" class="table table-hover">
                      <thead>
                        <tr>
                    ...
                    <table id="module-content-bottom" class="table table-hover">
                      <thead>
                        <tr>
                  ...
                  <!-- column right -->
                  <div class="col-lg-3 col-md-4 col-sm-12 column-right">
                    <table id="module-column-right" class="table table-hover">
                      <thead>
                        <tr>
            	...
            	<!-- Main Bottom -->
                <div class="row">
                	<div class="col-lg-12 col-md-12 col-sm-12 main-bottom-module">
                		 <table id="module-main-bottom" class="table table-hover">
                      <thead>
                        <tr>
                          <td class="text-left">Main Bottom</td>
                        </tr>
                      </thead>
                      <tbody>
                        <?php foreach ($layout_modules as $layout_module) { ?>
                        <?php if ($layout_module['position'] == 'main_bottom') { ?>
                        <tr id="module-row<?php echo $module_row; ?>">
                          <td class="text-left"><div class="input-group">
                              <select name="layout_module[<?php echo $module_row; ?>][code]" class="form-control input-sm">
                                <?php foreach ($extensions as $extension) { ?>
                      ...
                      <tfoot>
                        <tr>
                          <td class="text-left"><div class="input-group">
                              ...
                              <div class="input-group-btn">
                                <button type="button" onclick="addModule('main-bottom');" data-toggle="tooltip" title="<?php echo $button_module_add; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i></button>
                              </div>
                            </div></td>
                        </tr>
                      </tfoot>
            ...
            <div class="row">
            	<!-- footer top -->
            	<div class="col-lg-12 col-md-12 col-sm-12 footer-top-module">
            		<table id="module-footer-top" class="table table-hover">
                  <thead>
                    <tr>
                      <td class="text-center">Footer Top</td>
                    </tr>
                  </thead>
                  <tbody>
                    <?php foreach ($layout_modules as $layout_module) { ?>
            	...
            	<!-- footer bottom -->
            	<div class="col-lg-12 col-md-12 col-sm-12 footer-bottom-module">
            		<table id="module-footer-bottom" class="table table-hover">
                  <thead>
                    <tr>
                      <td class="text-center">Footer Bottom</td>
                    </tr>
                  </thead>
                  <tbody>
                    <?php foreach ($layout_modules as $layout_module) { ?>
                  ...
                  <tfoot>
                    <tr>
                      <td class="text-left"><div class="input-group">
                          ...
                          <div class="input-group-btn">
                            <button type="button" onclick="addModule('footer-bottom');" data-toggle="tooltip" title="<?php echo $button_module_add; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i></button>
                          </div>
                        </div></td>
                    </tr>
                  </tfoot>
...
$('#module-header-top, #module-header-bottom, #module-main-top, #module-main-bottom, #module-column-left, #module-column-right, #module-content-top, #module-content-bottom, #module-footer-top, #module-footer-bottom').delegate('select[name*=\'code\']', 'change', function() {
...
$('#module-header-top, #module-header-bottom, #module-main-top, #module-main-bottom, #module-column-left, #module-column-right, #module-content-top, #module-content-bottom, #module-footer-top, #module-footer-bottom').trigger('change');
//--></script> 
</div>
<?php echo $footer; ?>