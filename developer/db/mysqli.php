<?php
DIR_SYSTEM . 'library/db/sqli.php';
/**
 * sqli Class
 *
...
class sqli
{
    ...
    public function __construct($r)
    {
        ...
        // if host were set as sqli socket
        if (is_object($host)) {
            $this->_mysqli = $host;
        } else {
            $this->host = $host;
    ...
    public function connect()
    {
        ...
        $this->_mysqli = new sqli($this->host, $this->username, $this->password, $this->db, $this->port);
    ...
    /**
     * A method to get sqli object or create it in case needed
     *
     * @return sqli
     */
     ...
     *
     * @return sqli Returns the current instance.
     */
	...
	/**
	 * Pushes a unprepared statement to the sqli stack.
    ...
    /**
     * Method to call sqli->ping() to keep unused connections open on
     * long-running scripts, or to reconnect timed out connections (if php.ini has
     * global sqli.reconnect set to true). Can't do this directly using object
    ...
    protected function _dynamicBindResults(mysqli_stmt $stmt)
    {
        ...
        $results = array();
        /**
         * @see http://php.net/manual/en/sqli-result.fetch-fields.php
         */
        $mysqlLongType = 252;
        ...
        // avoid out of memory bug in php 5.2 and 5.3. sqli allocates lot of memory for long*
    ...
    /**
     * Referenced data array is required by sqli since PHP 5.3+
     *
     * @param array $arr
     *
     * @return array
     ...
     *
     * @return sqli new mysqlidb object
     */
